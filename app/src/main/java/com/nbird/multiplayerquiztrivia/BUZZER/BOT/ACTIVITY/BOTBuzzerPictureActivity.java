...
public class BOTBuzzerPictureActivity extends AppCompatActivity {
    ...
    CountDownTimer countDownTimer,c,cm;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_botbuzzer_picture);
        ...
        if(appData.getSharedPreferencesBoolean(AppString.SP_MAIN,AppString.SP_IS_SHOW_ADS, BOTBuzzerPictureActivity.this)){
        ...
        myName=appData.getSharedPreferencesString(AppString.SP_MAIN,AppString.SP_MY_NAME, BOTBuzzerPictureActivity.this);
        myPicURL=appData.getSharedPreferencesString(AppString.SP_MAIN,AppString.SP_MY_PIC, BOTBuzzerPictureActivity.this);



        supportAlertDialog=new SupportAlertDialog(loadingDialog,BOTBuzzerPictureActivity.this);
        ...
        SupportAlertDialog supportAlertDialog=new SupportAlertDialog(loadingDialog, BOTBuzzerPictureActivity.this);
        supportAlertDialog.showLoadingDialog();
        ...
        botplayerDisplayInQuiz=new BOTPlayerDisplayInQuiz(BOTBuzzerPictureActivity.this,recyclerView, numberOfQuestions,playerInfoGetterListener,2);
    ...
    public void fireBaseData2 ( int setNumber){
        myRef.child("PictureQuizMain").child(String.valueOf(setNumber)).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(BOTBuzzerPictureActivity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
                supportAlertDialog.dismissLoadingDialog();
                finish();
            }
        });
    ...
    public void mainManupulations(){
        ...
        if (num == numberOfQuestions) {
            ...
            if (list.size() > 0) {
                ...
                finish();
                Toast.makeText(BOTBuzzerPictureActivity.this, "No Questions", Toast.LENGTH_SHORT).show();
            }
            supportAlertDialog.dismissLoadingDialog();
        }
    }
    ...
    public void playMusic(int id){
        ...
        musicNav = MediaPlayer.create(BOTBuzzerPictureActivity.this,id);
        musicNav.start();
...
//        }
    ...
    public void quizFinishDialog(){
        ...
        Dialog dialog=null;
        SupportAlertDialog supportAlertDialog=new SupportAlertDialog(dialog,BOTBuzzerPictureActivity.this);
        supportAlertDialog.showLoadingDialog();
        ...
        table_user.child("BOT_TOURNAMENT").child("RESULT").child(mAuth.getCurrentUser().getUid()).child(mAuth.getCurrentUser().getUid()).setValue(dataExchangeHolder).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                if(mInterstitialAd!=null) {
                    ...
                    mInterstitialAd.show(BOTBuzzerPictureActivity.this);
    ...
    private void intentFun(){
        ...
        Intent intent=new Intent(BOTBuzzerPictureActivity.this, BOTBuzzerScoreActivity.class);
    ...
    public void songStopperAndResumer(){
        ...
        if(appData.getSharedPreferencesBoolean(AppString.SP_MAIN,AppString.SP_SONG,BOTBuzzerPictureActivity.this)){
        ...
        cardViewSpeaker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(appData.getSharedPreferencesBoolean(AppString.SP_MAIN,AppString.SP_SONG,BOTBuzzerPictureActivity.this)){
                    ...
                    Speaker.setBackgroundResource(R.drawable.usedicon);
                    speakerImage.setBackgroundResource(R.drawable.music_off);
                    appData.setSharedPreferencesBoolean(AppString.SP_MAIN,AppString.SP_SONG,BOTBuzzerPictureActivity.this,false);
                }else{
                    songActivity=new SongActivity(BOTBuzzerPictureActivity.this);
                    songActivity.startMusic();
                    Speaker.setBackgroundResource(R.drawable.single_color_2);
                    speakerImage.setBackgroundResource(R.drawable.music_on);
                    appData.setSharedPreferencesBoolean(AppString.SP_MAIN,AppString.SP_SONG,BOTBuzzerPictureActivity.this,true);
                }
            }
        });
    }
    ...
    public void quitScoreActivityActivity(){
        AlertDialog.Builder builderRemove=new AlertDialog.Builder(BOTBuzzerPictureActivity.this, R.style.AlertDialogTheme);
        View viewRemove1= LayoutInflater.from(BOTBuzzerPictureActivity.this).inflate(R.layout.dialog_model_2,(ConstraintLayout) findViewById(R.id.layoutDialogContainer),false);
        ...
        if(appData.getSharedPreferencesBoolean(AppString.SP_MAIN,AppString.SP_IS_SHOW_ADS, BOTBuzzerPictureActivity.this)){
            MobileAds.initialize(BOTBuzzerPictureActivity.this);
            AdLoader adLoader = new AdLoader.Builder(BOTBuzzerPictureActivity.this, AppString.NATIVE_ID)
        ...
        yesButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent=new Intent(BOTBuzzerPictureActivity.this, MainActivity.class);
                startActivity(intent);
                finish();
