...
public class BuzzerNormalActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myName=appData.getSharedPreferencesString(AppString.SP_MAIN,AppString.SP_MY_NAME, BuzzerNormalActivity.this);
        myPicURL=appData.getSharedPreferencesString(AppString.SP_MAIN,AppString.SP_MY_PIC, BuzzerNormalActivity.this);

        // timer=new NormalBUZZERTimer(countDownTimer,time*1000,1000,BuzzerNormalActivity.this,timerText,clockCardView);

        supportAlertDialog=new SupportAlertDialog(loadingDialog,BuzzerNormalActivity.this);
    ...
    public void fireBaseData2 ( int setNumber){
        myRef.child("NormalQuizBIGJSON").child(String.valueOf(setNumber)).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(BuzzerNormalActivity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    public void mainManupulations(){
        ...
        if (num == listAns.size()) {
            ...
            if (list.size() > 0) {
                ...
                finish();
                Toast.makeText(BuzzerNormalActivity.this, "No Questions", Toast.LENGTH_SHORT).show();
            }
            supportAlertDialog.dismissLoadingDialog();
        }
    }
    ...
    public void playMusic(int id){
        ...
        musicNav = MediaPlayer.create(BuzzerNormalActivity.this,id);
        musicNav.start();
...
//        });
    ...
    public void songStopperAndResumer(){
        ...
        if(appData.getSharedPreferencesBoolean(AppString.SP_MAIN,AppString.SP_SONG,BuzzerNormalActivity.this)){
        ...
        cardViewSpeaker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(appData.getSharedPreferencesBoolean(AppString.SP_MAIN,AppString.SP_SONG,BuzzerNormalActivity.this)){
                    ...
                    Speaker.setBackgroundResource(R.drawable.usedicon);
                    speakerImage.setBackgroundResource(R.drawable.music_off);
                    appData.setSharedPreferencesBoolean(AppString.SP_MAIN,AppString.SP_SONG,BuzzerNormalActivity.this,false);
                }else{
                    songActivity=new SongActivity(BuzzerNormalActivity.this);
                    songActivity.startMusic();
                    Speaker.setBackgroundResource(R.drawable.single_color_2);
                    speakerImage.setBackgroundResource(R.drawable.music_on);
                    appData.setSharedPreferencesBoolean(AppString.SP_MAIN,AppString.SP_SONG,BuzzerNormalActivity.this,true);
                }
            }
        });
    }
    ...
    public void quitScoreActivityActivity(){
        AlertDialog.Builder builderRemove=new AlertDialog.Builder(BuzzerNormalActivity.this, R.style.AlertDialogTheme);
        View viewRemove1= LayoutInflater.from(BuzzerNormalActivity.this).inflate(R.layout.dialog_model_2,(ConstraintLayout) findViewById(R.id.layoutDialogContainer),false);
