...
import com.nbird.multiplayerquiztrivia.TOURNAMENT.ACTIVITY.BOTTournamentAudioActivity;
import com.nbird.multiplayerquiztrivia.TOURNAMENT.ACTIVITY.BOTTournamentNormalActivity;
import com.nbird.multiplayerquiztrivia.TOURNAMENT.ACTIVITY.BOTTournamentPictureActivity;
...
public class BOTLobbyBuzzerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_botlobby_buzzer);
        ...
        if(appData.getSharedPreferencesBoolean(AppString.SP_MAIN,AppString.SP_IS_SHOW_ADS, BOTLobbyBuzzerActivity.this)){
        ...
        myName=appData.getSharedPreferencesString(AppString.SP_MAIN,AppString.SP_MY_NAME,BOTLobbyBuzzerActivity.this);
        myPicStr=appData.getSharedPreferencesString(AppString.SP_MAIN,AppString.SP_MY_PIC,BOTLobbyBuzzerActivity.this);
        ...
        settingDialog=new BOTSettingDialog(BOTLobbyBuzzerActivity.this,modeTextView,timeTextView,questionTextView,gameMode,timeInt,numberofQuestion);
                        ...
                        if(yo[0]==0){
                            ...
                            timerForNumberOfPlayers=new CountDownTimer(1000*kj,1000) {
                                ...
                                public void onTick(long l) {
                                    ...
                                    if(playerDataArrayList.size()<AppString.BUZZER_MAX_PLAYERS){
        ...
        factButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                FactsDialog factsDialog=new FactsDialog(BOTLobbyBuzzerActivity.this,NATIVE_ADS);
        ...
        troubleshoot.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                TroubleShootDialog troubleShootDialog=new TroubleShootDialog(BOTLobbyBuzzerActivity.this,NATIVE_ADS);
        ...
        settingButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                settingDialog.start(settingButton,2);
            }
        });
        ...
        removePlayerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                RemovePlayerDialog removePlayerDialog=new RemovePlayerDialog(BOTLobbyBuzzerActivity.this,roomCode);
    ...
    public void intentFunction(){
        ...
        if(settingDialog.gameModeInt==1){
            intent=new Intent(BOTLobbyBuzzerActivity.this, BOTBuzzerNormalActivity.class);
        }else if(settingDialog.gameModeInt==2){
            intent=new Intent(BOTLobbyBuzzerActivity.this, BOTBuzzerPictureActivity.class);
        }
    ...
    public void myAdder(){
        ...
        Dialog dialog=null;
        SupportAlertDialog supportAlertDialog=new SupportAlertDialog(dialog,BOTLobbyBuzzerActivity.this);
        ...
        table_user.child("LeaderBoard").child(mAuth.getCurrentUser().getUid()).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                try {
                    ...
                    String name=appData.getSharedPreferencesString(AppString.SP_MAIN,AppString.SP_MY_NAME, BOTLobbyBuzzerActivity.this);
                    String imageURL=appData.getSharedPreferencesString(AppString.SP_MAIN,AppString.SP_MY_PIC,BOTLobbyBuzzerActivity.this);
    ...
    public void playerInfoAdder(){
        ...
        if(minutes%2==0){
            ...
            if(bb){
                ...
                if(bn){
                    BOTLobbyBuzzerActivity.DownloadTask task = new BOTLobbyBuzzerActivity.DownloadTask();
    ...
    public class DownloadTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                e.printStackTrace();
                Toast.makeText(BOTLobbyBuzzerActivity.this, "Data Not Available", Toast.LENGTH_SHORT).show();
            }
        }
    }

    public void quitLobbyActivity(){
        AlertDialog.Builder builderRemove=new AlertDialog.Builder(BOTLobbyBuzzerActivity.this, R.style.AlertDialogTheme);
        View viewRemove1= LayoutInflater.from(BOTLobbyBuzzerActivity.this).inflate(R.layout.dialog_model_2,(ConstraintLayout) findViewById(R.id.layoutDialogContainer),false);
        ...
        AppData appData=new AppData();
        if(appData.getSharedPreferencesBoolean(AppString.SP_MAIN,AppString.SP_IS_SHOW_ADS, BOTLobbyBuzzerActivity.this)){
            MobileAds.initialize(BOTLobbyBuzzerActivity.this);
            AdLoader adLoader = new AdLoader.Builder(BOTLobbyBuzzerActivity.this, AppString.NATIVE_ID)
        ...
        yesButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent=new Intent(BOTLobbyBuzzerActivity.this, MainActivity.class);
                intent.putExtra("notificationOfHost",1);
                BOTLobbyBuzzerActivity.this.startActivity(intent);
                ((Activity) BOTLobbyBuzzerActivity.this).finish();
