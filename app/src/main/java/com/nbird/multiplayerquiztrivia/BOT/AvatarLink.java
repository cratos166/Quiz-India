...
public class AvatarLink {
    ...
    public ArrayList<String> getArr(){
       arr=new ArrayList<>();
       arr.add(urlAva1);arr.add(urlAva2);arr.add(urlAva3);arr.add(urlAva4);arr.add(urlAva5);arr.add(urlAva6);arr.add(urlAva7);arr.add(urlAva8);
        arr.add(urlAva9);arr.add(urlAva10);arr.add(urlAva11);arr.add(urlAva12);arr.add(urlAva13);arr.add(urlAva14);arr.add(urlAva15);arr.add(urlAva16);
        arr.add(urlAva17);arr.add(urlAva18);arr.add(urlAva19);arr.add(urlAva20);arr.add(urlAva21);arr.add(urlAva22);arr.add(urlAva23);arr.add(urlAva24);arr.add(urlAva25);
        arr.add(urlAva26);
        return arr;
    }
}
