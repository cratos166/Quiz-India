...
public class MainActivity extends AppCompatActivity {
    ...
    public void start(){
        ...
        avaMunupulator( cardView1, urlAva1, linearLayout1); avaMunupulator( cardView2, urlAva2, linearLayout2); avaMunupulator( cardView3, urlAva3, linearLayout3);
        avaMunupulator( cardView4, urlAva4, linearLayout4); avaMunupulator( cardView5, urlAva5, linearLayout5); avaMunupulator( cardView6, urlAva6, linearLayout6);
        avaMunupulator( cardView7, urlAva7, linearLayout7); avaMunupulator( cardView10, urlAva10, linearLayout10); avaMunupulator( cardView8, urlAva8, linearLayout8);
        avaMunupulator( cardView9, urlAva9, linearLayout9); avaMunupulator( cardView11, urlAva11, linearLayout11); avaMunupulator( cardView12, urlAva12, linearLayout12);
        avaMunupulator( cardView13, urlAva13, linearLayout13); avaMunupulator( cardView14, urlAva14, linearLayout14); avaMunupulator( cardView15, urlAva15, linearLayout15);
        avaMunupulator( cardView16, urlAva16, linearLayout16); avaMunupulator( cardView17, urlAva17, linearLayout17); avaMunupulator( cardView18, urlAva18, linearLayout18);
        avaMunupulator( cardView19, urlAva19, linearLayout19); avaMunupulator( cardView20, urlAva20, linearLayout20); avaMunupulator( cardView21, urlAva21, linearLayout21);
        avaMunupulator( cardView22, urlAva22, linearLayout22); avaMunupulator( cardView23, urlAva23, linearLayout23); avaMunupulator( cardView24, urlAva24, linearLayout24);
        avaMunupulator( cardView25, urlAva25, linearLayout25); avaMunupulator( cardView26, urlAva26, linearLayout26);
