...
import com.nbird.multiplayerquiztrivia.Dialog.DialogBotWaiterVS;
import com.nbird.multiplayerquiztrivia.Dialog.DialogJoinOrCreate;
import com.nbird.multiplayerquiztrivia.R;
import com.nbird.multiplayerquiztrivia.SharePreferene.AppData;

public class OnlineLocalDialog {
    NativeAd NATIVE_ADS;
    public void start(Context context, View view){
        ...
        onlineCard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try{NATIVE_ADS.destroy();}catch (Exception e){}
                BOTJoinCreateTournamentDialog botJoinCreateTournamentDialog=new BOTJoinCreateTournamentDialog();
                botJoinCreateTournamentDialog.start(context,onlineCard);
                alertDialog.dismiss();
            }
        });
