...
public class PlayerDisplayInQuizAadapter extends RecyclerView.Adapter<PlayerDisplayInQuizAadapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        view=mInflater.inflate(R.layout.tournament_quiz_player_item,parent,false);
