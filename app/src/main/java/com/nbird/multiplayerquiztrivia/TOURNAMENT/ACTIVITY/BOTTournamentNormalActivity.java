...
public class BOTTournamentNormalActivity extends AppCompatActivity {
    ...
    public static final int VARIABLE_BOT_TIME=7;
    ...
    CountDownTimer botAnswerUploader;
    int numberOfPlayers;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bottournament_normal);
        ...
        if(appData.getSharedPreferencesBoolean(AppString.SP_MAIN,AppString.SP_IS_SHOW_ADS, BOTTournamentNormalActivity.this)){
        ...
        myName=appData.getSharedPreferencesString(AppString.SP_MAIN,AppString.SP_MY_NAME, BOTTournamentNormalActivity.this);
        myPicURL=appData.getSharedPreferencesString(AppString.SP_MAIN,AppString.SP_MY_PIC, BOTTournamentNormalActivity.this);


        llManupulator=new LLManupulator(audienceLL,expertAdviceLL,fiftyfiftyLL,swapTheQuestionLL);

        // timer=new NormalTournamentTimer(countDownTimer,time*1000,1000,BOTTournamentNormalActivity.this,timerText,clockCardView);



        supportAlertDialog=new SupportAlertDialog(loadingDialog,BOTTournamentNormalActivity.this);
        ...
        botplayerDisplayInQuiz=new BOTPlayerDisplayInQuiz(BOTTournamentNormalActivity.this,recyclerView, numberOfQuestions,playerInfoGetterListener,1);
    ...
    public void lifeLine(){
        ...
        lifeLine=new LifeLine(linearLayoutFiftyFifty,linearLayoutAudience,linearLayoutexpert,position,list,option1,option2,option3,option4,myName,BOTTournamentNormalActivity.this);
    ...
    public void fireBaseData2 ( int setNumber){
        myRef.child("NormalQuizBIGJSON").child(String.valueOf(setNumber)).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(BOTTournamentNormalActivity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    public void mainManupulations(){
        ...
        if (num == numberOfQuestions) {
            ...
            if (list.size() > 0) {
                ...
                finish();
                Toast.makeText(BOTTournamentNormalActivity.this, "No Questions", Toast.LENGTH_SHORT).show();
            }
            supportAlertDialog.dismissLoadingDialog();
        }
    }
    ...
    public void playMusic(int id){
        ...
        musicNav = MediaPlayer.create(BOTTournamentNormalActivity.this,id);
        musicNav.start();
...
//        }
        ...
        Dialog dialog=null;
        SupportAlertDialog supportAlertDialog=new SupportAlertDialog(dialog,BOTTournamentNormalActivity.this);
        supportAlertDialog.showLoadingDialog();

        Record record =new Record(scoreGenerator.start(),score,1,BOTTournamentNormalActivity.this,audienceLL,timeTakenInt,myName,myPicURL);
        ...
        table_user.child("BOT_TOURNAMENT").child("RESULT").child(mAuth.getCurrentUser().getUid()).child(mAuth.getCurrentUser().getUid()).setValue(dataExchangeHolder).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                if(mInterstitialAd!=null) {
                    ...
                    mInterstitialAd.show(BOTTournamentNormalActivity.this);
    ...
    private void intentFun(){
        ...
        Intent intent=new Intent(BOTTournamentNormalActivity.this, BOTScoreActivity.class);
    ...
    public void songStopperAndResumer(){
        ...
        if(appData.getSharedPreferencesBoolean(AppString.SP_MAIN,AppString.SP_SONG,BOTTournamentNormalActivity.this)){
        ...
        cardViewSpeaker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(appData.getSharedPreferencesBoolean(AppString.SP_MAIN,AppString.SP_SONG,BOTTournamentNormalActivity.this)){
                    ...
                    Speaker.setBackgroundResource(R.drawable.usedicon);
                    speakerImage.setBackgroundResource(R.drawable.music_off);
                    appData.setSharedPreferencesBoolean(AppString.SP_MAIN,AppString.SP_SONG,BOTTournamentNormalActivity.this,false);
                }else{
                    songActivity=new SongActivity(BOTTournamentNormalActivity.this);
                    songActivity.startMusic();
                    Speaker.setBackgroundResource(R.drawable.single_color_2);
                    speakerImage.setBackgroundResource(R.drawable.music_on);
                    appData.setSharedPreferencesBoolean(AppString.SP_MAIN,AppString.SP_SONG,BOTTournamentNormalActivity.this,true);
                }
            }
        });
    }
    ...
    public void quitScoreActivityActivity(){
        AlertDialog.Builder builderRemove=new AlertDialog.Builder(BOTTournamentNormalActivity.this, R.style.AlertDialogTheme);
        View viewRemove1= LayoutInflater.from(BOTTournamentNormalActivity.this).inflate(R.layout.dialog_model_2,(ConstraintLayout) findViewById(R.id.layoutDialogContainer),false);
        ...
        if(appData.getSharedPreferencesBoolean(AppString.SP_MAIN,AppString.SP_IS_SHOW_ADS, BOTTournamentNormalActivity.this)){
            MobileAds.initialize(BOTTournamentNormalActivity.this);
            AdLoader adLoader = new AdLoader.Builder(BOTTournamentNormalActivity.this, AppString.NATIVE_ID)
        ...
        yesButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent=new Intent(BOTTournamentNormalActivity.this,MainActivity.class);
                startActivity(intent);
                finish();
    ...
    private void setCountDownTimer(){
        countDownTimer=new CountDownTimer(time*1000, 1000) {
            ...
            public void onFinish() {
                ...
                Toast.makeText(BOTTournamentNormalActivity.this, "Time Over", Toast.LENGTH_SHORT).show();
                quizFinishDialog();
