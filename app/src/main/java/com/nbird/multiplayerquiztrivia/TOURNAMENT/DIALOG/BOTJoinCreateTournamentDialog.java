...
public class BOTJoinCreateTournamentDialog {
    ...
    public void start(Context context, View view) {
        ...
        categoryAdapter = new BOTRoomListAdapter(context,list,1);
        ...
        createButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent=new Intent(context, BOTLobbyActivity.class);
