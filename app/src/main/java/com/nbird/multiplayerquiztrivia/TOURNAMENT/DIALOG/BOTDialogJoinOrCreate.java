...
import com.nbird.multiplayerquiztrivia.Dialog.DialogJoinVS;
import com.nbird.multiplayerquiztrivia.Dialog.DialogWaiterVS;
...
public class BOTDialogJoinOrCreate {
    NativeAd NATIVE_ADS;
    AppData appData;
