                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        try{
                            ...
                            if(isCompletedOppo){
                                ...
                                WaitingVSInGameDialog waitingVSInGameDialog =new WaitingVSInGameDialog(myPicURL,myName,String.valueOf(score), finalTimeTakenString,String.valueOf(score*10),String.valueOf(lifelineSum),VsVideoQuiz.this,questionTextView);
