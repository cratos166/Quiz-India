...
public class NormalPictureQuiz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(appData.getSharedPreferencesBoolean(AppString.SP_MAIN,AppString.SP_IS_SHOW_ADS, NormalPictureQuiz.this)){
...
//            supportAlertDialog.dismissLoadingDialog();
    ...
    public void timer(){
        countDownTimer=new CountDownTimer(180*1000, 1000) {
            ...
            public void onFinish() {
                ...
                Toast.makeText(NormalPictureQuiz.this, "Time Over", Toast.LENGTH_SHORT).show();
                quizFinishDialog();
    ...
    public void quizFinishDialog(){
        ...
        if(mInterstitialAd!=null) {
            ...
            mInterstitialAd.show(NormalPictureQuiz.this);
            ...
            mInterstitialAd.setFullScreenContentCallback(new FullScreenContentCallback() {
                ...
                public void onAdFailedToShowFullScreenContent(@NonNull AdError adError) {
                    ...
                    ResultHandling resultHandling =new ResultHandling(NormalPictureQuiz.this,map,animList,score,timeTakenString,
                            ...
                            category,2,timeTakenInt,NATIVE_ADS);
    ...
    public void onBackPressed() {
        QuizCancelDialog quizCancelDialog=new QuizCancelDialog(NormalPictureQuiz.this,countDownTimer,option1,songActivity,NATIVE_ADS);
