...
public class VsPictureQuiz extends AppCompatActivity {
    ...
    public void mainManupulations(){
        ...
        num++;
        if (num == 10) {
            timer=new QuizTimer(countDownTimer,60000*3,1000,VsPictureQuiz.this,timerText,clockCardView);
            timer.start();
            if (list.size() > 0) {
                for (int i = 0; i < 4; i++) {
    ...
    public void quizFinishDialog(){
        ...
        ResultHandling resultHandling =new ResultHandling(VsPictureQuiz.this,map,animList,score,timeTakenString,
    ...
    public void onBackPressed() {
        QuizCancelDialog quizCancelDialog=new QuizCancelDialog(VsPictureQuiz.this,timer.getCountDownTimer(),option1,songActivity);
